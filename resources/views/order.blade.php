                        ...
                        <div class="tab-pane  fade  active show" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                            ...
                            <div class="bg-white card mb-4 order-list shadow-sm">
                                <div class="gold-members p-4">
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="mr-4 img-size" src="https://bootdey.com/img/Content/avatar/avatar2.png" alt="Generic placeholder image">
                                        </a>
                                        <div class="media-body">
                                            ...
                                            <p class="text-gray mb-1"><i class="fas fa-location-arrow"></i> 730 S Mendenhall Rd, Memphis, TN 38117, USA
                                            </p>
                                            <p class="text-gray mb-3"><i class="fas fa-file-invoice"></i> ORDER #25102589748 <i class="icofont-clock-time ml-2"></i> Mon, Nov 12, 6:26 PM</p>
                                            <p class="text-dark">Description of the product
                                            </p>
                                            <hr>
                                            <p class="mb-0 text-black text-primary pt-2"><span class="text-black font-weight-bold"> Total Price:</span> $300
                                            </p>
                                        </div>
                                    </div>
